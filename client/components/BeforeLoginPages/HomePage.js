...
class HomePage extends Component {
  render() {
    return (
      <ResponsiveContainer logined={this.props.isLoggedIn}>
        <Segment
            ...
            <Grid.Row textAlign="center">
              ...
              >
                ...
                <p style={{ fontSize: "1.33em" }}>
                  ...
                  bank-level security.
                  <br />
                  Midas is a simple, safe, smart way to save - mobile banking
            ...
            <Grid.Row>
              <Grid.Column width={8}>
                ...
                <p style={{ fontSize: "1.33em" }}>
                  ...
                  automatically update every time you sign in to show you
                  current (and categorised!) transactions. Wealth building
                  begins with healthy financial habits.
                </p>
              </Grid.Column>
          ...
          <Grid celled="internally" columns="equal" stackable>
            <Grid.Row textAlign="center">
              <Grid.Column style={{ paddingBottom: "5em", paddingTop: "5em" }}>
                ...
                <p style={{ fontSize: "1.33em" }}>
                  <b>Midas</b> Sign up and sync a bank account easily. Manage
